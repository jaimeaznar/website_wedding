...
const translations = {
    en: {
        ...
        'rsvp.transport.hotel': 'Transport back to the hotel /to Cáceres',
        ...
        'rsvp.family.title': 'Additional Members',
        ...
        'schedule.travel.time': 'Buses leave at 19:30 sharp — please be at the pickup point a few minutes early.',
        'schedule.travel.description': 'Transportation provided',
        'schedule.reception': 'Reception & Celebration',
        'schedule.reception.time': '20:15 onwards',
        ...
        'schedule.dancing.until': '00:00 - Late',
        ...
        'activities.caceres.plaza.desc': 'Next to the old town, with its walls, iconic buildings, and the Arch of the Star.',
        ...
        'activities.caceres.pintores.desc': 'One of the traditional streets of the historic center that leads to the Main Square.',
        'activities.caceres.convents': 'Las jeronimas y Santa Clara convents',
        'activities.caceres.convents.desc': 'Buy handmade sweets made by the cloistered nuns through the revolving windows.',
        ...
        'activities.caceres.cathedral.desc': 'Gothic cathedral, wedding ceremony venue',
        'activities.caceres.viewpoints.title': 'Viewpoints & Scenic Spots',
        'activities.caceres.montana.desc': 'One of the best views of the city! Perfect for sunset.',
        ...
        'activities.caceres.preciosa.desc': 'Beautiful church near the Cathedral, worth a quick visit',
        'activities.caceres.arenales.desc': 'Historic noble palace of the Golfín family',
        'activities.caceres.pizarro.desc': 'Lively street with shops, bars and restaurants',
        'activities.caceres.charlotte.desc': 'Great for brunch and afternoon snacks',
        'activities.caceres.bars.title': 'Casual Bar Areas',
        'activities.caceres.avmontana.desc': 'bars, local vibe',
        ...
        // Shopping section
        'activities.wheretoshop': 'Local Products & Shopping',
        'activities.caceres.gourmet.title': 'Gourmet & Delicatessen',
        'activities.caceres.mostazo.desc': 'Local delicatessen with regional products.',
        'activities.caceres.chinata.desc': 'Famous olive oil products and cosmetics from Extremadura',
        ...
        'dresscode.women.no.patterns': 'Bold or extravagant patterns',
        'dresscode.women.no.sequins': 'Sequins (New Year\'s Eve style)',
        ...
        // 'welcome.bus.title': 'Buses',
        // 'welcome.bus.description': 'Throughout the wedding day we\'ll show you exactly where to catch the bus to the reception venue and display the bus departure times so you know when the buses leave back to the hotels.',
        // 'welcome.button': 'Got it!',
        // 'welcome.dontshow': 'Don\'t show this again',
        "welcome.title": "Welcome!",
        "welcome.intro": "This website has everything you need for our wedding day.",
        "welcome.description": "You can confirm your attendance and check all the information about the wedding.",
        "welcome.bus.description": "On the wedding day, we'll show you where to catch the bus to the reception venue and the departure times for the buses back to the hotels.",
        "welcome.button": "Got it!",
        "welcome.dontshow": "Don't show this again",
    ...
    es: {
        ...
        'rsvp.transport.hotel': 'Transporte de vuelta al hotel / Cáceres',
        ...
        'rsvp.family.title': 'Miembros adicionales',
        ...
        'rsvp.update': 'Actualizar Confirmación',
        ...
        'schedule.travel.time': 'Los autobuses salen a las 19:30 en punto — por favor, llega al punto de recogida unos minutos antes.',
        'schedule.travel.description': 'Transporte proporcionado',
        'schedule.reception': 'Banquete y Celebración',
        'schedule.reception.time': '20:15 en adelante',
        ...
        'schedule.dancing.until': '00:00 - Cierre',
        ...
        'activities.caceres.plaza.desc': 'Junto al casco antiguo, con murallas, edificios emblemáticos y el arco de la estrella.',
        ...
        'activities.caceres.pintores.desc': 'Una de las calles tradicionales del centro histórico que lleva a la Plaza Mayor',
        'activities.caceres.convents': 'Conventos Las jeronimas y Santa Clara',
        'activities.caceres.convents.desc': 'Compra dulces artesanos elaborados por las monjas de clausura a través de los tornos.',
        ...
        'activities.caceres.preciosa.desc': 'Bonita iglesia cerca de la Concatedral, merece una visita rápida',
        'activities.caceres.arenales.desc': 'Palacio histórico de la familia noble Golfín',
        'activities.caceres.pizarro.desc': 'Calle animada con tiendas, bares y restaurantes',
        'activities.caceres.charlotte.desc': 'Genial para brunch y meriendas',
        'activities.caceres.bars.title': 'Zonas de Bares',
        'activities.caceres.avmontana.desc': 'Bares, ambiente local',
        ...
        // 'welcome.bus.title': 'Autobuses',
        // 'welcome.bus.description': 'En el día de la boda también iremos comunicando dónde coger el autobús hacia el lugar de celebración y los horarios de salida de los autobuses de vuelta a los hoteles.',
        // 'welcome.button': 'Entendido!',
        // 'welcome.dontshow': 'No mostrar de nuevo',
        "welcome.title": "¡Bienvenido!",
        "welcome.intro": "En esta web encontrarás todo lo que necesitas para el día de nuestra boda.",
        "welcome.description": "Podrás confirmar tu asistencia y consultar toda la información relativa a la boda.",
        "welcome.bus.description": "En el día de la boda también iremos comunicando dónde coger el autobús hacia el lugar de celebración y los horarios de salida de los autobuses de vuelta a los hoteles.",
        "welcome.button": "¡Entendido!",
        "welcome.dontshow": "No mostrar de nuevo",
    }
